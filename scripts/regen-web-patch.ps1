...
$series = @('0001-aemeath-web-client.patch', '0002-aemeath-management-ui.patch', '0003-aemeath-desktop-tray-subtitle.patch', '0004-aemeath-learning-pages.patch', '0005-aemeath-training-wizard.patch')
